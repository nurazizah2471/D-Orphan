...
public class ApiService {
    ...
    public Call<Register> register(String email, String password, String password_confirmation, String type_user){
        return api.register(email, password, password_confirmation, type_user);
    }
